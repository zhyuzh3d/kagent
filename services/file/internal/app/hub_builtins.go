...
func BuiltinServiceManifests() []ServiceManifest {
	return []ServiceManifest{
		...
		},
		{
			...
			Visibility:  "public",
			Provides: []ServiceToolDescriptor{
				{ToolID: "storage.database.query", Category: "storage", Type: "database", Tool: "query", Description: "query rows", ScopeSupport: []string{"user", "surface", "service"}, AllowedCallerTypes: []string{"user", "surface", "service"}},
				{ToolID: "storage.database.insert", Category: "storage", Type: "database", Tool: "insert", Description: "insert row", ScopeSupport: []string{"user", "surface", "service"}, AllowedCallerTypes: []string{"user", "surface", "service"}},
				{ToolID: "storage.database.update", Category: "storage", Type: "database", Tool: "update", Description: "update row", ScopeSupport: []string{"user", "surface", "service"}, AllowedCallerTypes: []string{"user", "surface", "service"}},
				{ToolID: "storage.database.delete", Category: "storage", Type: "database", Tool: "delete", Description: "delete row", ScopeSupport: []string{"user", "surface", "service"}, AllowedCallerTypes: []string{"user", "surface", "service"}},
				{ToolID: "storage.database.execute", Category: "storage", Type: "database", Tool: "execute", Description: "execute SQL", ScopeSupport: []string{"user", "surface", "service"}, AllowedCallerTypes: []string{"user", "surface", "service"}},
				{ToolID: "storage.database.schema", Category: "storage", Type: "database", Tool: "schema", Description: "show schema", ScopeSupport: []string{"user", "surface", "service"}, AllowedCallerTypes: []string{"user", "surface", "service"}},
			},
		},
		{
			ServiceID:   "auth",
