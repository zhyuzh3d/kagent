...
export function createChatActionEngine(options) {
  ...
  function handleSurfaceEffect(turnId, evt) {
    ...
    if ((evt.type === "state_change" || evt.type === "surface_open" || evt.type === "surface_close" || evt.type === "surface_closed")
      ...
      reportStateChange({
        ...
        surface_name: typeof evt.payload.surface_name === "string" ? evt.payload.surface_name : "",
        surface_title: typeof evt.payload.surface_title === "string" ? evt.payload.surface_title : "",
        event_type: evt.payload.event_type || evt.type || "state_change",
