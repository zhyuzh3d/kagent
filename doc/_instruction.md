...
4. 需要术语定义时，读 [`doc/_instruction/glossary.md`](./_instruction/glossary.md)。
5. 需要最近改动或历史演进时，读 [`doc/_devlog.md`](./_devlog.md)。

## 读取原则

- 默认先读入口，再按任务补读专题文档。
- `doc/_devlog.md` 只负责历史增量，不在说明文档里重复维护。
- 需要当前状态判断时，以专题文档和真实代码/Git 证据为准。
...
**文档更新时间**：2026-03-19 13:12 CST

**信息来源**：仓库实时文件核验与当前文档拆分决策。
